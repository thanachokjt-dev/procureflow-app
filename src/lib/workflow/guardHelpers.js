...
export const WORKFLOW_ACTION_ROLE_PERMISSIONS = {
  [WORKFLOW_ACTIONS.CREATE_PR]: APP_ROLE_LIST,
  [WORKFLOW_ACTIONS.SUBMIT_PR]: APP_ROLE_LIST,
  ...
  [WORKFLOW_ACTIONS.CONFIRM_VARIANCE]: [APP_ROLES.MANAGER, APP_ROLES.ADMIN],
  [WORKFLOW_ACTIONS.FINAL_APPROVE_PO]: [APP_ROLES.MD_ASSISTANT, APP_ROLES.ADMIN],
