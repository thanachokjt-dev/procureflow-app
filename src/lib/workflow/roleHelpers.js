...
export const PAGE_KEYS = {
  ...
  VARIANCE_CONFIRMATION: 'variance_confirmation',
...
export const PAGE_ROLE_ACCESS = {
  ...
  [PAGE_KEYS.NEW_REQUEST]: APP_ROLE_LIST,
  [PAGE_KEYS.REQUESTS]: [
    APP_ROLES.REQUESTER,
    APP_ROLES.MANAGER,
    APP_ROLES.PROCUREMENT,
  ...
  [PAGE_KEYS.VARIANCE_CONFIRMATION]: [
    APP_ROLES.MANAGER,
    APP_ROLES.PROCUREMENT,
    APP_ROLES.ADMIN,
  ],
  [PAGE_KEYS.FINAL_APPROVAL_QUEUE]: [APP_ROLES.MD_ASSISTANT, APP_ROLES.ADMIN],
  [PAGE_KEYS.PROCUREMENT_QUEUE]: [APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
  [PAGE_KEYS.PO_DRAFT]: [APP_ROLES.MANAGER, APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
  [PAGE_KEYS.SUPPLIER_MASTER]: [APP_ROLES.MANAGER, APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
  [PAGE_KEYS.ITEM_MASTER]: [APP_ROLES.MANAGER, APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
  [PAGE_KEYS.WORKFLOW_DEBUG]: [APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
}

export const SIDEBAR_ROLE_ACCESS = {
  [PAGE_KEYS.DASHBOARD]: [
    APP_ROLES.REQUESTER,
    APP_ROLES.MANAGER,
    APP_ROLES.MD_ASSISTANT,
  ...
  [PAGE_KEYS.MANAGER_APPROVAL]: [APP_ROLES.MANAGER, APP_ROLES.ADMIN],
  [PAGE_KEYS.VARIANCE_CONFIRMATION]: [APP_ROLES.MANAGER, APP_ROLES.ADMIN],
  [PAGE_KEYS.FINAL_APPROVAL_QUEUE]: [APP_ROLES.MD_ASSISTANT, APP_ROLES.ADMIN],
  [PAGE_KEYS.PROCUREMENT_QUEUE]: [APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
  [PAGE_KEYS.SUPPLIER_MASTER]: [APP_ROLES.MANAGER, APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
  [PAGE_KEYS.ITEM_MASTER]: [APP_ROLES.MANAGER, APP_ROLES.PROCUREMENT, APP_ROLES.ADMIN],
