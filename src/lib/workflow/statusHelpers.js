...
export const PR_STATUS_LABELS = {
  ...
  [PR_STATUSES.PARTIALLY_CONVERTED_TO_PO]: 'Partially Converted to PO',
...
const STATUS_BADGE_CLASSES = {
  ...
  [PR_STATUSES.PARTIALLY_CONVERTED_TO_PO]: 'bg-sky-50 text-sky-700 ring-sky-600/20',
...
export const PR_STATUS_TRANSITIONS = {
  ...
  [PR_STATUSES.SUBMITTED]: [PR_STATUSES.APPROVED, PR_STATUSES.REJECTED, PR_STATUSES.DRAFT],
